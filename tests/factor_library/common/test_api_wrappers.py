...
class TestAPIWrappers:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (lambda: FactorAPI(token="token"), "get_agent_factory_config", (), {"coin_category": "main"}, "GET", "/api/v1/agent-factory-config", {"coin_category": "main"}, None),
            ...
            (lambda: FactorAPI(token="token"), "refresh_sub_factor", (66,), {}, "POST", "/api/v1/sub-factors/66/refresh", None, None),
            (lambda: FactorAPI(token="token"), "get_sub_factor_refresh", (66, "refresh-1"), {}, "GET", "/api/v1/sub-factors/66/refresh/refresh-1", {}, None),
            ...
            (lambda: FactorICAPI(token="token"), "get_factor_by_symbol", (123,), {"ic_scope": "time_series", "time_window": "1d"}, "GET", "/api/v1/factor-ic/factors/123/by-symbol", {"ic_scope": "time_series", "time_window": "1d"}, None),
            ...
            (lambda: FactorICAPI(token="token"), "get_sub_factor_by_symbol", (66,), {"ic_scope": "cross_sectional", "time_window": "1d"}, "GET", "/api/v1/factor-ic/sub-factors/66/by-symbol", {"ic_scope": "cross_sectional", "time_window": "1d"}, None),
            ...
            (lambda: AdminAPI(token="token"), "list_invite_codes", (), {}, "GET", "/api/v1/admin/invite-codes", {}, None),
            ...
            (lambda: AdminAPI(token="token"), "update_agent_factory_config", ({"agent_enabled": True},), {"coin_category": "main"}, "PUT", "/api/v1/admin/agent-factory-config", {"coin_category": "main"}, {"agent_enabled": True}),
            ...
            (lambda: AdminAPI(token="token"), "list_prompts", (), {"used_by": "agent", "limit": 5}, "GET", "/api/v1/admin/prompts", {"used_by": "agent", "limit": 5}, None),
            (lambda: AdminAPI(token="token"), "create_prompt", ({"name": "auto_prompt", "type": "system", "used_by": "agent", "user_prompt": "test"},), {}, "POST", "/api/v1/admin/prompts", None, {"name": "auto_prompt", "type": "system", "used_by": "agent", "user_prompt": "test"}),
            (lambda: AdminAPI(token="token"), "update_prompt", (8, {"name": "auto_prompt"}), {}, "PUT", "/api/v1/admin/prompts/8", None, {"name": "auto_prompt"}),
